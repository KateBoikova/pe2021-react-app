...
class UserHW extends Component {
  constructor(props) {
    ...
    this.state = {
       ...
       lastName: 'Cheshire',
       age: 100,
       imgSrc: 'https://i.pinimg.com/originals/8d/34/f3/8d34f3056e8f7e9f3db0b45e3aa47ec9.jpg',
       likesCount: 0,
  ...
  render() {
    ...
    return (
      <div className='main'>
        ...
        <div>{age}</div>
        <p>{lastName} {firstName} has {likesCount} likes</p> 
        <div>
          <button title={'Add more likes'} onClick={this.incrementLikes}>+</button>
        </div>
      </div>
    )
  }
